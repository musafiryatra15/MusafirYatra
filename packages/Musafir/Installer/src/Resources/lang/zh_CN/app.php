    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'musafiryatra-info' => '正在创建数据库表，这可能需要一些时间',
                'musafiryatra'      => 'MusafirYatra 安装',
                'title'        => '安装',
            ],

            'installation-completed' => [
                'admin-panel'                => '管理员面板',
                'musafiryatra-forums'             => 'MusafirYatra 论坛',
                'customer-panel'             => '客户面板',
                'explore-musafiryatra-extensions' => '探索 MusafirYatra 扩展',
                'title'                      => '安装已完成',
                'title-info'                 => 'MusafirYatra 已成功安装在您的系统上。',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => '创建数据库表',
                'install'                 => '安装',
                'install-info'            => 'MusafirYatra 安装信息',
            ...
            'start' => [
                ...
                'title'         => '您的 MusafirYatra 安装',
                'welcome-title' => '欢迎来到 MusafirYatra',
            ],
            ...
            'back'                     => '返回',
            'musafiryatra'                  => 'MusafirYatra',
            'musafiryatra-info'             => '由 Musafir 社区共同开发的项目',
            ...
            'hebrew'                   => '希伯来语',
            'hindi'                    => '印地语',
            'installation-description' => 'MusafirYatra 的安装通常涉及几个步骤。以下是 MusafirYatra 安装过程的一般概述',
            'installation-info'        => '我们很高兴在这里见到你！',
            'installation-title'       => '欢迎安装 MusafirYatra',
            'italian'                  => '意大利语',
            'japanese'                 => '日语',
            'persian'                  => '波斯语',
            'polish'                   => '波兰语',
