...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'musafiryatra'              => 'Багісто',
            'email'                => 'Електронна пошта',
            'email-not-exist'      => 'Ми не можемо знайти користувача за цією адресою електронної пошти.',
            'footer'               => '© Копірайт 2010 - :current_year, Musafir Software (зареєстрована в Індії). Всі права захищені.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Авторське право 2010 - :current_year, Musafir Software (зареєстровано в Індії). Усі права захищені.',
                'locale'                 => 'Мова',
