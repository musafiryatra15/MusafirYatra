...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => 'Пароль',
            'powered-by-description' => 'Работает на :musafiryatra, проект с открытым исходным кодом от :Musafir.',
            'submit-btn'             => 'Войти',
            'title'                  => 'Войти',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Работает на :musafiryatra, проект с открытым исходным кодом от :Musafir.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'Разработано на платформе <a href="https://musafiryatra.com/" target="_blank">MusafirYatra</a>, Проект сообщества <a href="https://Musafir.com/" target="_blank">Musafir</a>',
    ],
