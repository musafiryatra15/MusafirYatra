{!! view_render_event('musafiryatra.admin.sales.order.create.cart.items.before') !!}
...
{!! view_render_event('musafiryatra.admin.sales.order.create.cart.items.after') !!}
    ...
    >
        <div class="box-shadow rounded bg-white dark:bg-gray-900">
            ...
            <div
                ...
                v-else
            >
                <img src="{{ musafiryatra_asset('images/icon-add-product.svg') }}" class="h-20 w-20 dark:mix-blend-exclusion dark:invert">
