{!! view_render_event('musafiryatra.admin.catalog.product.edit.booking.appointment.before', ['product' => $product]) !!}

<!-- Vue Component -->
<v-appointment-booking :bookingProduct="$bookingProduct ?? []"></v-appointment-booking>

{!! view_render_event('musafiryatra.admin.catalog.product.edit.booking.appointment.after', ['product' => $product]) !!}
