...
use Musafir\Installer\Database\Seeders\Category\CategoryTableSeeder;
...
class ProductTableSeeder extends Seeder
{
     ...
     */
    const BASE_PATH = 'packages/Musafir/Installer/src/Resources/assets/images/seeders/products/';
