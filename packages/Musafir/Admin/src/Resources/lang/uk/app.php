...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => 'Пароль',
            'powered-by-description' => 'Працює на платформі :musafiryatra, спільний проект :Musafir.',
            'submit-btn'             => 'Увійти',
            'title'                  => 'Увійти',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Працює на платформі :musafiryatra, спільний проект :Musafir.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'Працює на платформі <a href="https://musafiryatra.com/" target="_blank">MusafirYatra</a>, Спільний проект <a href="https://Musafir.com/" target="_blank">Musafir</a>',
    ],
