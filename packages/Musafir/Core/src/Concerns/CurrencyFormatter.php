...
namespace Musafir\Core\Concerns;

use Musafir\Core\Contracts\Currency;
...
trait CurrencyFormatter
{
     ...
     *
     * @param  string|\Musafir\Core\Contracts\Currency  $currency
     */
    public function currencySymbol($currency): string
    {
        $code = $currency instanceof \Musafir\Core\Contracts\Currency ? $currency->code : $currency;
