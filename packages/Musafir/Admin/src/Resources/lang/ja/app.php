...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => 'パスワード',
            'powered-by-description' => ':Musafir によるオープンソースプロジェクト :musafiryatra によって提供されています。',
            'submit-btn'             => 'サインイン',
            'title'                  => 'サインイン',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => ':Musafir によるオープンソースプロジェクト :musafiryatra によって提供されています。',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '搭載 <a href="https://musafiryatra.com/" target="_blank">MusafirYatra</a>, Musafirによるコミュニティプロジェクト<a href="https://Musafir.com/" target="_blank">Musafir</a>',
    ],
