{!! view_render_event('musafiryatra.admin.sales.order.create.compare_items.before') !!}
...
{!! view_render_event('musafiryatra.admin.sales.order.create.compare_items.after') !!}
