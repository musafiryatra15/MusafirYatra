...
use Musafir\Sales\Contracts\Invoice as InvoiceContract;
use Musafir\Sales\Database\Factories\InvoiceFactory;
use Musafir\Sales\Traits\InvoiceReminder;
use Musafir\Sales\Traits\PaymentTerm;
