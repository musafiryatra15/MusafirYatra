    ...
    <div class="flex h-[100vh] items-center justify-center">
        <div class="flex flex-col items-center gap-5">
            ...
            @else
                <img
                    class="w-max" 
                    src="{{ musafiryatra_asset('images/logo.svg') }}"
                    alt="{{ config('app.name') }}"
                />
            @endif
            ...
            <div class="text-sm font-normal">
                @lang('admin::app.users.reset-password.powered-by-description', [
                    'musafiryatra' => '<a class="text-blue-600 hover:underline" href="https://musafiryatra.com/en/">MusafirYatra</a>',
                    'Musafir' => '<a class="text-blue-600 hover:underline" href="https://Musafir.com/">Musafir</a>',
                ])
            </div>
        </div>
    </div>
