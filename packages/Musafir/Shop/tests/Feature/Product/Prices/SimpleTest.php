...
use Musafir\CartRule\Models\CartRule;
use Musafir\CartRule\Models\CartRuleCoupon;
use Musafir\CatalogRule\Models\CatalogRule;
use Musafir\CatalogRule\Models\CatalogRuleProductPrice;
...
use Musafir\Product\Models\ProductCustomerGroupPrice;
use Musafir\Tax\Models\TaxCategory;
use Musafir\Tax\Models\TaxMap;
use Musafir\Tax\Models\TaxRate;
...
it('should fails the validation error when the product id not provided add a simple product to the cart with a cart rule of the specific coupon type for all customer grouped types', function () {
    ...
    $cartRuleCoupon = CartRuleCoupon::factory()->create([
        ...
        'code'         => fake()->numerify('musafiryatra-########'),
        'type'         => 0,
        'is_primary'   => 1,
    ]);
...
it('should add a simple product to the cart with a cart rule of the specific coupon type for all customer grouped types', function () {
    ...
    $cartRuleCoupon = CartRuleCoupon::factory()->create([
        'cart_rule_id' => $cartRule->id,
        'code'         => $couponCode = fake()->numerify('musafiryatra-########'),
        'type'         => 0,
        'is_primary'   => 1,
    ]);
