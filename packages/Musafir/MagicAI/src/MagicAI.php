...
namespace Musafir\MagicAI;

use Musafir\MagicAI\Services\Gemini;
use Musafir\MagicAI\Services\GroqAI;
use Musafir\MagicAI\Services\Ollama;
use Musafir\MagicAI\Services\OpenAI;
