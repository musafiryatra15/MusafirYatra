{!! view_render_event('musafiryatra.admin.sales.order.create.cart.shipping.before') !!}
...
{!! view_render_event('musafiryatra.admin.sales.order.create.cart.shipping.after') !!}
