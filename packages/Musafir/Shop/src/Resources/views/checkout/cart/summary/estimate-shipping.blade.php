...
{!! view_render_event('musafiryatra.shop.checkout.cart.summary.estimate_shipping.before') !!}
...
{!! view_render_event('musafiryatra.shop.checkout.cart.summary.estimate_shipping.after') !!}
            ...
            <form @change="handleSubmit($event, estimateShipping)">
                ...
                >
                    <template v-for="method in methods">
                        {!! view_render_event('musafiryatra.shop.checkout.onepage.shipping.before') !!}
                        ...
                        {!! view_render_event('musafiryatra.shop.checkout.onepage.shipping.after') !!}
                    </template>
                </div>
            </form>                    
        </x-shop::form>
