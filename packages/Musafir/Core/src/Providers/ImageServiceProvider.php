 ...
 * supports all versions of Laravel, but this class only supports the current Laravel version used by MusafirYatra.
 */
    ...
    protected function bootstrapImageCache()
    {
        ...
        if (is_string(config('imagecache.route'))) {
            ...
            $this->app['router']->get(config('imagecache.route').'/{template}/{filename}', [
                'uses' => 'Musafir\Core\ImageCache\Controller@getResponse',
                'as'   => 'imagecache',
