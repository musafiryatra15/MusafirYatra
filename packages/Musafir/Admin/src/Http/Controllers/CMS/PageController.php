...
namespace Musafir\Admin\Http\Controllers\CMS;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Musafir\Admin\DataGrids\CMS\CMSPageDataGrid;
use Musafir\Admin\Http\Controllers\Controller;
use Musafir\Admin\Http\Requests\MassDestroyRequest;
use Musafir\CMS\Repositories\PageRepository;
...
class PageController extends Controller
{
    ...
    public function store()
    {
        $this->validate(request(), [
            'url_key'      => ['required', 'unique:cms_page_translations,url_key', new \Musafir\Core\Rules\Slug],
            'page_title'   => 'required',
    ...
    public function update(int $id)
    {
        ...
        $this->validate(request(), [
            $locale.'.url_key'      => ['required', new \Musafir\Core\Rules\Slug, function ($attribute, $value, $fail) use ($id) {
