...
use Musafir\BookingProduct\Contracts\BookingProduct;
use Musafir\BookingProduct\Repositories\BookingProductAppointmentSlotRepository;
use Musafir\BookingProduct\Repositories\BookingProductDefaultSlotRepository;
use Musafir\BookingProduct\Repositories\BookingProductEventTicketRepository;
use Musafir\BookingProduct\Repositories\BookingProductRentalSlotRepository;
use Musafir\BookingProduct\Repositories\BookingProductRepository;
use Musafir\BookingProduct\Repositories\BookingProductTableSlotRepository;
...
class Booking
{
     ...
     *
     * @param  \Musafir\Checkout\Contracts\CartItem|array  $cartItem
     */
