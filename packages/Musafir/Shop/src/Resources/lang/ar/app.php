...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'musafiryatra'              => 'باغيستو',
            'email'                => 'البريد الإلكتروني',
            'email-not-exist'      => 'لا يمكننا العثور على مستخدم بهذا البريد الإلكتروني',
            'footer'               => '© حقوق الطبع والنشر 2010 - :current_year، Musafir Software (مسجلة في الهند). جميع الحقوق محفوظة.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© حقوق النشر 2010 - :current_year ، Musafir Software (مسجلة في الهند). كل الحقوق محفوظة.',
                'locale'                 => 'اللغة',
