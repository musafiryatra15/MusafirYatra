...
use Musafir\Core\Http\Middleware\NoCacheMiddleware;
use Musafir\Shop\Http\Controllers\Customer\Account\AddressController;
use Musafir\Shop\Http\Controllers\Customer\Account\DownloadableProductController;
use Musafir\Shop\Http\Controllers\Customer\Account\OrderController;
use Musafir\Shop\Http\Controllers\Customer\Account\WishlistController;
use Musafir\Shop\Http\Controllers\Customer\CustomerController;
use Musafir\Shop\Http\Controllers\Customer\ForgotPasswordController;
use Musafir\Shop\Http\Controllers\Customer\GDPRController;
use Musafir\Shop\Http\Controllers\Customer\RegistrationController;
use Musafir\Shop\Http\Controllers\Customer\ResetPasswordController;
use Musafir\Shop\Http\Controllers\Customer\SessionController;
use Musafir\Shop\Http\Controllers\DataGridController;
