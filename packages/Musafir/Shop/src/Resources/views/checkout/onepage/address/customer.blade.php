{!! view_render_event('musafiryatra.shop.checkout.onepage.address.customer.before') !!}
...
{!! view_render_event('musafiryatra.shop.checkout.onepage.address.customer.after') !!}
