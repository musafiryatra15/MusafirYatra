...
namespace Musafir\CartRule\Helpers;

use Carbon\Carbon;
use Illuminate\Database\Eloquent\Builder;
use Musafir\CartRule\Repositories\CartRuleCouponRepository;
use Musafir\CartRule\Repositories\CartRuleCouponUsageRepository;
use Musafir\CartRule\Repositories\CartRuleCustomerRepository;
use Musafir\CartRule\Repositories\CartRuleRepository;
...
use Musafir\Rule\Helpers\Validator;
...
class CartRule
{
     ...
     *
     * @param  \Musafir\CartRule\Contracts\CartRule  $rule
     */
    public function canProcessRule($rule): bool
    {
        if ($rule->coupon_type) {
            ...
            /** @var \Musafir\CartRule\Models\CartRule $rule */
