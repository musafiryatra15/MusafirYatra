<x-admin::layouts>
    ...
    {!! view_render_event('musafiryatra.admin.marketing.search_seo.search_terms.create.before') !!}
    ...
    {!! view_render_event('musafiryatra.admin.marketing.search_seo.search_terms.create.after') !!}
