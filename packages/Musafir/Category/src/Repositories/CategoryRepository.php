...
namespace Musafir\Category\Repositories;

use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Str;
use Intervention\Image\ImageManager;
use Musafir\Category\Contracts\Category;
use Musafir\Category\Models\CategoryTranslationProxy;
...
class CategoryRepository extends Repository
{
     ...
     * Create category.
     *
     * @return \Musafir\Category\Contracts\Category
     */
