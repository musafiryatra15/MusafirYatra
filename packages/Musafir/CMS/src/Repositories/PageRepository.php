...
namespace Musafir\CMS\Repositories;

use Illuminate\Database\Eloquent\ModelNotFoundException;
use Musafir\CMS\Models\PageTranslationProxy;
...
class PageRepository extends Repository
{
    ...
    {
        return 'Musafir\CMS\Contracts\Page';
    }
     ...
     *
     * @param  string  $urlKey
     * @return \Musafir\CMS\Contracts\Page|\Exception
     */
