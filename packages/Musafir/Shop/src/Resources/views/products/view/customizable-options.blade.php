@if ($product->getTypeInstance()->isCustomizable())
    ...
    @if ($options->isNotEmpty())
        {!! view_render_event('musafiryatra.shop.products.view.customizable-options.before', ['product' => $product]) !!}
        ...
        {!! view_render_event('musafiryatra.shop.products.view.customizable-options.after', ['product' => $product]) !!}
