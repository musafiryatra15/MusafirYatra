...
namespace Musafir\CatalogRule\Helpers;

use Carbon\Carbon;
use Musafir\Attribute\Repositories\AttributeRepository;
use Musafir\CatalogRule\Repositories\CatalogRuleProductRepository;
...
class CatalogRuleProduct
{
     ...
     *
     * @param  \Musafir\CatalogRule\Contracts\CatalogRule  $rule
