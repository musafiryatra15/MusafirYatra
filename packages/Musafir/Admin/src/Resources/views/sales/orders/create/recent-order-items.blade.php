{!! view_render_event('musafiryatra.admin.sales.order.create.recent_order_items.before') !!}
...
{!! view_render_event('musafiryatra.admin.sales.order.create.recent_order_items.after') !!}
