...
namespace Musafir\Installer\Console\Commands;
...
use Musafir\Installer\Events\ComposerEvents;
use Musafir\Installer\Helpers\DatabaseManager;
...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'musafiryatra:install
     ...
     * @var string
     */
    protected $description = 'MusafirYatra installer.';
    ...
    /**
     * Install and configure musafiryatra.
     */
    public function handle(): void
    {
        ...
        $this->warn('Step: Seeding basic data for MusafirYatra kickstart...');
        app(MusafirYatraDatabaseSeeder::class)->run($this->getSeederConfiguration());
    ...
    protected function askForApplicationDetails(): void
    {
        $this->updateTextTypeEnv(
            ...
            $this->getEnvVariable('APP_NAME', 'MusafirYatra')
        );
    ...
    protected function askForAdminDetails()
    {
        ...
        try {
            ...
            File::put($filePath, 'MusafirYatra is successfully installed.');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use MusafirYatra.');
            ...
            Event::dispatch('musafiryatra.installed');
        } catch (\Exception $e) {
    ...
    protected function askForGithubStar(): void
    {
        ...
        $repoUrl = 'https://github.com/musafiryatra/musafiryatra';
