...
namespace Musafir\Checkout;

use Illuminate\Support\Facades\Event;
use Musafir\Checkout\Contracts\CartAddress as CartAddressContract;
use Musafir\Checkout\Exceptions\BillingAddressNotFoundException;
use Musafir\Checkout\Models\CartAddress;
use Musafir\Checkout\Models\CartPayment;
use Musafir\Checkout\Repositories\CartAddressRepository;
use Musafir\Checkout\Repositories\CartItemRepository;
use Musafir\Checkout\Repositories\CartRepository;
use Musafir\Customer\Contracts\Customer as CustomerContract;
use Musafir\Customer\Contracts\Wishlist as WishlistContract;
use Musafir\Customer\Repositories\CustomerAddressRepository;
use Musafir\Customer\Repositories\WishlistRepository;
use Musafir\Product\Contracts\Product as ProductContract;
...
class Cart
{
     ...
     * The cart instance.
     *
     * @var \Musafir\Checkout\Contracts\Cart
     */
    private $cart;
