...
use Musafir\Core\Http\Middleware\PreventRequestsDuringMaintenance;
use Musafir\Shop\Http\Middleware\AuthenticateCustomer;
use Musafir\Shop\Http\Middleware\CacheResponse;
use Musafir\Shop\Http\Middleware\Currency;
use Musafir\Shop\Http\Middleware\Locale;
use Musafir\Shop\Http\Middleware\Theme;
