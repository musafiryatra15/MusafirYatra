...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'musafiryatra'              => 'Багисто',
            'email'                => 'Электронная почта',
            'email-not-exist'      => 'Мы не можем найти пользователя с этим адресом электронной почты.',
            'footer'               => '© Авторское право 2010 - :current_year, Musafir Software (зарегистрировано в Индии). Все права защищены.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Авторское право 2010 - :current_year, Musafir Software (зарегистрировано в Индии). Все права защищены.',
                'locale'                 => 'Язык',
