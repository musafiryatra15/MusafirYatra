...
namespace Musafir\Theme\Models;

use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Musafir\Admin\Database\Factories\ThemeFactory;
use Musafir\Core\Eloquent\TranslatableModel;
use Musafir\Theme\Contracts\ThemeCustomization as ThemeCustomizationContract;
