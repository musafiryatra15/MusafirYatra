...
use Musafir\Admin\Validations\ConfigurableUniqueSku;
use Musafir\Checkout\Models\CartItem as CartItemModel;
use Musafir\Product\DataTypes\CartItemValidationResult;
use Musafir\Product\Facades\ProductImage;
use Musafir\Product\Helpers\Indexers\Price\Configurable as ConfigurableIndexer;
use Musafir\Tax\Facades\Tax;
...
class Configurable extends AbstractType
{
     ...
     *
     * @param  \Musafir\Customer\Contracts\Wishlist  $item
     * @return bool
     */
    ...
    {
        $childProduct = app('Musafir\Product\Repositories\ProductRepository')->find($data['selected_configurable_option']);
     ...
     *
     * @param  \Musafir\Customer\Contracts\Wishlist|\Musafir\Checkout\Contracts\CartItem  $item
     * @return array
     */
    public function getBaseImage($item)
    {
        ...
        if ($item instanceof \Musafir\Customer\Contracts\Wishlist) {
     ...
     *
     * @param  \Musafir\Product\Type\CartItem  $item
     */
