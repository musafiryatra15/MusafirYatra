...
namespace Musafir\Admin\Http\Controllers\Marketing\Communications;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Musafir\Admin\DataGrids\Marketing\Communications\EmailTemplateDataGrid;
use Musafir\Admin\Http\Controllers\Controller;
use Musafir\Marketing\Repositories\TemplateRepository;
