...
namespace Musafir\Admin\Http\Controllers\Catalog;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Storage;
use Musafir\Admin\DataGrids\Catalog\ProductDataGrid;
use Musafir\Admin\Http\Controllers\Controller;
use Musafir\Admin\Http\Requests\InventoryRequest;
use Musafir\Admin\Http\Requests\MassDestroyRequest;
use Musafir\Admin\Http\Requests\MassUpdateRequest;
use Musafir\Admin\Http\Requests\ProductForm;
use Musafir\Admin\Http\Resources\AttributeResource;
use Musafir\Admin\Http\Resources\ProductResource;
...
use Musafir\Product\Helpers\ProductType;
use Musafir\Product\Repositories\ProductAttributeValueRepository;
use Musafir\Product\Repositories\ProductDownloadableLinkRepository;
use Musafir\Product\Repositories\ProductDownloadableSampleRepository;
