    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'musafiryatra'          => 'Instalação do MusafirYatra',
                'musafiryatra-info'     => 'A criação de tabelas no banco de dados pode levar alguns momentos',
                'title'            => 'Instalação',
            ],

            'installation-completed' => [
                'admin-panel'                => 'Painel de Administração',
                'musafiryatra-forums'             => 'Fórum MusafirYatra',
                'customer-panel'             => 'Painel do Cliente',
                'explore-musafiryatra-extensions' => 'Explorar Extensões MusafirYatra',
                'title'                      => 'Instalação Concluída',
                'title-info'                 => 'O MusafirYatra foi instalado com sucesso no seu sistema.',
            ],
            ...
            'back'                     => 'Wstecz',
            'musafiryatra'                  => 'MusafirYatra',
            'musafiryatra-info'             => 'Projekt społecznościowy',
            ...
            'hebrew'                   => 'Hebrajski',
            'hindi'                    => 'Hinduski',
            'installation-description' => 'A instalação do MusafirYatra geralmente envolve várias etapas. Aqui está uma visão geral do processo de instalação do MusafirYatra',
