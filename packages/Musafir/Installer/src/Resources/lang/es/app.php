    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'musafiryatra'      => 'Instalación de MusafirYatra',
                'musafiryatra-info' => 'Creando las tablas de la base de datos, esto puede tomar algunos momentos',
                'title'        => 'Instalación',
            ],

            'installation-completed' => [
                'admin-panel'                => 'Panel de administración',
                'musafiryatra-forums'             => 'Foro de MusafirYatra',
                'customer-panel'             => 'Panel de clientes',
                'explore-musafiryatra-extensions' => 'Explorar extensiones de MusafirYatra',
                'title'                      => 'Instalación completada',
                'title-info'                 => 'MusafirYatra se ha instalado correctamente en su sistema.',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => 'Crear la tabla de la base de datos',
                'install'                 => 'Instalación',
                'install-info'            => 'MusafirYatra para instalación',
            ...
            'start' => [
                ...
                'title'         => 'Tu instalación de MusafirYatra',
                'welcome-title' => 'Bienvenido a MusafirYatra',
            ],
            ...
            'back'                     => 'Atrás',
            'musafiryatra'                  => 'MusafirYatra',
            'musafiryatra-info'             => 'Un proyecto comunitario por',
            ...
            'hebrew'                   => 'Hebreo',
            'hindi'                    => 'Hindi',
            'installation-description' => 'La instalación de MusafirYatra generalmente implica varios pasos. Aquí hay un esquema general del proceso de instalación para MusafirYatra',
            ...
            'sinhala'                  => 'Cingalés',
            'spanish'                  => 'Español',
            'title'                    => 'Instalador de MusafirYatra',
            'turkish'                  => 'Turco',
            'ukrainian'                => 'Ucraniano',
            'Musafir'                   => 'Musafir',
        ],
