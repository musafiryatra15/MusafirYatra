...
namespace Musafir\Core;

use Carbon\Carbon;
use Illuminate\Support\Facades\DB;
use Musafir\Core\Concerns\CurrencyFormatter;
use Musafir\Core\Models\Channel;
use Musafir\Core\Repositories\ChannelRepository;
use Musafir\Core\Repositories\CountryRepository;
use Musafir\Core\Repositories\CountryStateRepository;
use Musafir\Core\Repositories\CurrencyRepository;
use Musafir\Core\Repositories\ExchangeRateRepository;
use Musafir\Core\Repositories\LocaleRepository;
use Musafir\Customer\Repositories\CustomerGroupRepository;
use Musafir\Tax\Repositories\TaxCategoryRepository;
...
class Core
{
     ...
     * Current Channel.
     *
     * @var \Musafir\Core\Models\Channel
     */
     ...
     * Currency.
     *
     * @var \Musafir\Core\Models\Currency
     */
     ...
     * Current Locale.
     *
     * @var \Musafir\Core\Models\Locale
     */
     ...
     *
     * @var \Musafir\Customer\Models\CustomerGroup
     */
    ...
    /**
     * Get the version number of the MusafirYatra.
     *
     * @return string
     */
     ...
     *
     * @return \Musafir\Core\Contracts\Channel
     */
     ...
     *
     * @return \Musafir\Core\Contracts\Locale
     */
     ...
     *
     * @return \Musafir\Core\Contracts\Currency
     */
     ...
     *
     * @param  int|string|\Musafir\Core\Contracts\Channel  $channel
     ...
     *
     * @return \Musafir\Customer\Contract\CustomerGroup
     */
