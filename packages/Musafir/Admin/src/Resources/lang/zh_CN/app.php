...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => '密码',
            'powered-by-description' => '由 :musafiryatra 提供支持，一个由 :Musafir 社区支持的项目。',
            'submit-btn'             => '登录',
            'title'                  => '登录',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '由 :musafiryatra 提供支持，一个由 :Musafir 社区支持的项目。',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '由 <a href="https://musafiryatra.com/" target="_blank">MusafirYatra</a> 提供支持，一个由 <a href="https://Musafir.com/" target="_blank">Musafir</a> 社区支持的项目',
    ],
