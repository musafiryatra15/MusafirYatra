@php
    $bookingProduct = app('\Musafir\BookingProduct\Repositories\BookingProductRepository')->findOneByField('product_id', $product->id)
@endphp

{!! view_render_event('musafiryatra.admin.catalog.product.edit.form.types.booking.before', ['product' => $product]) !!}

<!-- Vue Component -->
<v-booking-information></v-booking-information>

{!! view_render_event('musafiryatra.admin.catalog.product.edit.form.types.booking.after', ['product' => $product]) !!}
