...
namespace Musafir\Installer\Http\Controllers;
...
use Musafir\Installer\Helpers\EnvironmentManager;
use Musafir\Installer\Helpers\ServerRequirements;
...
class InstallerController extends Controller
{
    ...
    public function smtpConfigSetup()
    {
        ...
        File::put($filePath, 'Your MusafirYatra App is Successfully Installed');
