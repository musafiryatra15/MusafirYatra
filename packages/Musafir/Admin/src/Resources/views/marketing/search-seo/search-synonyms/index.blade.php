<x-admin::layouts>
    ...
    {!! view_render_event('musafiryatra.admin.marketing.search_seo.search_synonyms.create.before') !!}
    ...
    {!! view_render_event('musafiryatra.admin.marketing.search_seo.search_synonyms.create.after') !!}
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            {!! view_render_event('musafiryatra.admin.marketing.search_seo.search_synonyms.list.before') !!}
