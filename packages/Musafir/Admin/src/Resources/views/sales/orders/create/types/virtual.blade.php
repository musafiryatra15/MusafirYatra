{!! view_render_event('musafiryatra.admin.sales.order.create.types.virtual.before') !!}
...
{!! view_render_event('musafiryatra.admin.sales.order.create.types.virtual.after') !!}
