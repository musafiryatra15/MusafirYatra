...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'back'                 => 'חזרה להתחברות?',
            'musafiryatra'              => 'בַּגִּיסְטוֹ',
            'email'                => 'אימייל',
            'email-not-exist'      => 'אנחנו לא מוצאים משתמש עם כתובת הדוא"ל הזו.',
            'footer'               => '© זכויות יוצרים 2010 - :current_year, Musafir Software (רשומה בהודו). כל הזכויות שמורות.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© זכויות יוצרים 2010 - :current_year, Musafir Software (רשומה בהודו). כל הזכויות שמורות.',
                'locale'                 => 'אזור',
