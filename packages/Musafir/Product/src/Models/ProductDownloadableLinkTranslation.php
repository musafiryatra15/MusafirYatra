...
use Musafir\Product\Contracts\ProductDownloadableLinkTranslation as ProductDownloadableLinkTranslationContract;
use Musafir\Product\Database\Factories\ProductDownloadableLinkTranslationFactory;
