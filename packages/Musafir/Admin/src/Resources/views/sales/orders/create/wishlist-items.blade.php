{!! view_render_event('musafiryatra.admin.sales.order.create.wishlist_items.before') !!}
...
{!! view_render_event('musafiryatra.admin.sales.order.create.wishlist_items.after') !!}
