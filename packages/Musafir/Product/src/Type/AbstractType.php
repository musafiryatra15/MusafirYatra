...
use Musafir\Product\Repositories\ProductVideoRepository;
...
abstract class AbstractType
{
     ...
     * Product instance.
     *
     * @var \Musafir\Product\Models\Product
     */
    protected $product;
     ...
     * Create product.
     *
     * @return \Musafir\Product\Contracts\Product
     */
    ...
    /**
     * @param  string  $code
     * @return \Musafir\Attribute\Contracts\Attribute
     */
     ...
     *
     * @param  \Musafir\Product\Models\Product  $product
     */
     ...
     * @return \Musafir\Product\Type\AbstractType
     */
     ...
     *
     * @param  \Musafir\Checkout\Contracts\CartItem  $cartItem
     * @return bool
     */
     ...
     *
     * @param  \Musafir\Checkout\Contracts\CartItem  $item
     * @return bool
     */
     ...
     *
     * @param  \Musafir\Attribute\Contracts\Group  $group
     ...
     * Get tax category.
     *
     * @return \Musafir\Tax\Models\TaxCategory
     */
     ...
     *
     * @param  \Musafir\Checkout\Contracts\CartItem  $item
     * @return \Musafir\Checkout\Contracts\CartItem|\Musafir\Sales\Contracts\OrderItem|\Musafir\Sales\Contracts\InvoiceItem|\Musafir\Sales\Contracts\ShipmentItem|\Musafir\Customer\Contracts\Wishlist
     */
     ...
     *
     * @param  \Musafir\Customer\Contracts\CartItem|\Musafir\Checkout\Contracts\CartItem  $item
     * @return array
     */
     ...
     */
    public function isCartItemInactive(\Musafir\Checkout\Contracts\CartItem $item): bool
    {
