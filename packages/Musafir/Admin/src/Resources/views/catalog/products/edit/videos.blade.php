{!! view_render_event('musafiryatra.admin.catalog.product.edit.form.videos.before', ['product' => $product]) !!}
...
{!! view_render_event('musafiryatra.admin.catalog.product.edit.form.videos.after', ['product' => $product]) !!}