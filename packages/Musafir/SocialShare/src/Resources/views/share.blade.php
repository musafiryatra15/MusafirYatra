@if (core()->getConfigData('catalog.products.social_share.enabled'))
    ...
    <div class="flex gap-6">
        {!! view_render_event('musafiryatra.shop.products.view.share.before', ['product' => $product]) !!}
        ...
        {!! view_render_event('musafiryatra.shop.products.view.share.after', ['product' => $product]) !!}
    </div>
