...
use Musafir\Core\Facades\Acl;
use Musafir\Core\Facades\Core;
use Musafir\Core\Facades\Menu;
use Musafir\Core\Facades\SystemConfig;

if (! function_exists('core')) {
    /**
     * Core helper.
     *
     * @return \Musafir\Core\Core
     */
    function core()
    {
...
if (! function_exists('system_config')) {
     ...
     *
     * @return \Musafir\Core\SystemConfig
     */
