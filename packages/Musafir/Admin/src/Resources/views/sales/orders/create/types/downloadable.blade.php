{!! view_render_event('musafiryatra.admin.sales.order.create.types.grouped.before') !!}
...
{!! view_render_event('musafiryatra.admin.sales.order.create.types.grouped.after') !!}
