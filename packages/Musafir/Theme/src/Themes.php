...
namespace Musafir\Theme;

use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Vite;
use Illuminate\Support\Str;
use Musafir\Theme\Exceptions\ViterNotFound;
...
class Themes
{
    ...
    public function url(string $filename, ?string $namespace = null)
    {
         ...
         */
        $viters = config('musafiryatra-vite.viters');
    ...
    /**
     * Set musafiryatra vite in current theme.
     *
     * @param  mixed  $entryPoints
     * @return mixed
     */
    public function setMusafirYatraVite($entryPoints, ?string $namespace = null)
    {
        /**
         * If the namespace is null, it means the theming system is activated. We use the request URI to
         * detect the theme and provide Vite assets based on the current theme.
         */
        if (empty($namespace)) {
            return $this->current()->setMusafirYatraVite($entryPoints);
        }
