{!! view_render_event('musafiryatra.admin.catalog.product.edit.form.types.grouped.before', ['product' => $product]) !!}

<v-group-products :errors="errors"></v-group-products>

{!! view_render_event('musafiryatra.admin.catalog.product.edit.form.types.grouped.after', ['product' => $product]) !!}
