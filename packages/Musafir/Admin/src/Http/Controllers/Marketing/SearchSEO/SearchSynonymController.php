...
namespace Musafir\Admin\Http\Controllers\Marketing\SearchSEO;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Storage;
use Musafir\Admin\DataGrids\Marketing\SearchSEO\SearchSynonymDataGrid;
use Musafir\Admin\Http\Controllers\Controller;
use Musafir\Admin\Http\Requests\MassDestroyRequest;
use Musafir\Marketing\Repositories\SearchSynonymRepository;
