    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'musafiryatra'          => 'Installazione MusafirYatra',
                'musafiryatra-info'     => 'Creazione delle tabelle del Database, questo potrebbe richiedere qualche momento',
                'title'            => 'Installazione',
            ],

            'installation-completed' => [
                'admin-panel'                => 'Pannello di Amministrazione',
                'musafiryatra-forums'             => 'Forum di MusafirYatra',
                'customer-panel'             => 'Pannello del Cliente',
                'explore-musafiryatra-extensions' => 'Esplora le Estensioni di MusafirYatra',
                'title'                      => 'Installazione Completata',
                'title-info'                 => 'MusafirYatra è stato installato con successo sul tuo sistema.',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => 'Crea la tabella del database',
                'install'                 => 'Installazione',
                'install-info'            => 'MusafirYatra per l\'installazione',
            ...
            'start' => [
                ...
                'title'         => 'La tua installazione di MusafirYatra',
                'welcome-title' => 'Benvenuto in MusafirYatra',
            ],
            ...
            'back'                     => 'Indietro',
            'musafiryatra'                  => 'MusafirYatra',
            'musafiryatra-info'             => 'Un progetto della comunità di',
            'musafiryatra-logo'             => 'Logo MusafirYatra',
            'bengali'                  => 'Bengalese',
            'chinese'                  => 'Cinese',
            'continue'                 => 'Continua',
            'dutch'                    => 'Olandese',
            ...
            'hebrew'                   => 'Ebraico',
            'hindi'                    => 'Hindi',
            'installation-description' => 'L\'installazione di MusafirYatra generalmente prevede diversi passaggi. Ecco una panoramica generale del processo di installazione per MusafirYatra',
            ...
            'sinhala'                  => 'Singalese',
            'spanish'                  => 'Spagnolo',
            'title'                    => 'Installazione di MusafirYatra',
            'turkish'                  => 'Turco',
            'ukrainian'                => 'Ucraino',
            'Musafir'                   => 'Musafir',
        ],
