{!! view_render_event('musafiryatra.admin.sales.order.create.types.configurable.before') !!}
...
{!! view_render_event('musafiryatra.admin.sales.order.create.types.configurable.after') !!}
